            ...
            modelBuilder.Entity("ServerCore.DataModel.Puzzle", b =>
                {
                    ...
                    b.Property<int?>("UnlockWaveID");

                    b.HasKey("ID");

                    b.HasIndex("EventID");

                    b.HasIndex("UnlockWaveID");
            ...
            modelBuilder.Entity("ServerCore.DataModel.UnlockWave", b =>
                {
                    ...
                    b.ToTable("UnlockWave");
                });

            modelBuilder.Entity("ServerCore.DataModel.UnlockWavePerTeam", b =>
                {
                    b.Property<int>("WaveID");

                    b.Property<int>("TeamID");

                    b.Property<DateTimeOffset?>("TimeUnlocked");

                    b.HasKey("WaveID", "TeamID");

                    b.HasIndex("TeamID");

                    b.ToTable("UnlockWavePerTeam");
                });
            ...
            modelBuilder.Entity("ServerCore.DataModel.Puzzle", b =>
                {
                    ...
                    b.HasOne("ServerCore.DataModel.UnlockWave", "UnlockWave")
                        .WithMany("UnlockPuzzles")
                        .HasForeignKey("UnlockWaveID");
                });
            ...
            modelBuilder.Entity("ServerCore.DataModel.UnlockWavePerTeam", b =>
                {
                    ...
                    b.HasOne("ServerCore.DataModel.UnlockWave", "Wave")
                        .WithMany()
